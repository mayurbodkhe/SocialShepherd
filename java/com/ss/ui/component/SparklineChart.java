...
public class SparklineChart extends VerticalLayout {
    ...
    public SparklineChart(final String name, final String unit,
            ...
            final int min, final int  max, final int count, final double percentage) {
        setSizeUndefined();
        addStyleName("spark");
        setDefaultComponentAlignment(Alignment.TOP_CENTER);

        int[] values = randomSparklineValues(howManyPoints,min, max);

        Label current = new Label(prefix + percentage + unit);
        ...
        Label highLow = new Label("Mention <b>" + count
                + "</b>", ContentMode.HTML);
