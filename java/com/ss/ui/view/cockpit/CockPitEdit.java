...
public class CockPitEdit extends Window {

    private final TextField nameField = new TextField("Name");
    private final CockPitEditListener listener;

    public CockPitEdit(final CockPitEditListener listener,
            final String currentName) {
        this.listener = listener;
        setCaption("Edit CockPit");
        setModal(true);
        setClosable(false);
        setResizable(false);
    ...
    public interface CockPitEditListener {
